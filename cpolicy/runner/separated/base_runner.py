...
from cpolicy.utils.separated_buffer import SeparatedReplayBuffer
from cpolicy.utils.util import update_linear_schedule
...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from cpolicy.algorithms.happo.happo_trainer import HAPPO as TrainAlgo
            from cpolicy.algorithms.happo.policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from cpolicy.algorithms.hatrpo.hatrpo_trainer import HATRPO as TrainAlgo
            from cpolicy.algorithms.hatrpo.policy import HATRPO_Policy as Policy
        else:
            from cpolicy.algorithms.r_mappo.r_mappo import R_MAPPO as TrainAlgo
            from cpolicy.algorithms.r_mappo.algorithm.rMAPPOPolicy import R_MAPPOPolicy as Policy
