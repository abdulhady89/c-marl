...
from cpolicy.utils.util import get_shape_from_obs_space, get_shape_from_act_space
from cpolicy.algorithms.utils.util import check
from cpolicy.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer
