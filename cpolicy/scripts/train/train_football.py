...
from cpolicy.envs.football.Football_Env import FootballEnv
from cpolicy.envs.env_wrappers import SubprocVecEnv, DummyVecEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from cpolicy.runner.shared.football_runner import FootballRunner as Runner
    else:
        from cpolicy.runner.separated.football_runner import FootballRunner as Runner
