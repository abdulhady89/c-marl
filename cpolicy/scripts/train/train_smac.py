...
import torch
from cpolicy.config import get_config
from cpolicy.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv
...
def main(args):
    ...
    if all_args.env_name == "SMAC":
        ...
        from cpolicy.envs.starcraft2.smac_maps import get_map_params
        num_agents = get_map_params(all_args.map_name)["n_agents"]
    ...
    if all_args.share_policy:
        from cpolicy.runner.shared.smac_runner import SMACRunner as Runner
    else:
        from cpolicy.runner.separated.smac_runner import SMACRunner as Runner
