...
from cpolicy.envs.mpe.MPE_env import MPEEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from cpolicy.runner.shared.mpe_runner import MPERunner as Runner
    else:
        from cpolicy.runner.separated.mpe_runner import MPERunner as Runner
