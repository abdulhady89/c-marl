...
from cpolicy.envs.hanabi.Hanabi_Env import HanabiEnv
from cpolicy.envs.env_wrappers import ChooseSubprocVecEnv, ChooseDummyVecEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from cpolicy.runner.shared.hanabi_runner_forward import HanabiRunner as Runner
    else:
        from cpolicy.runner.separated.hanabi_runner_forward import HanabiRunner as Runner
